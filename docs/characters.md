...
**Captains**
### Aelindra
- Ancient and precise. Speaks as though each word costs something. Has outlived
  three forests and is not sentimental about it.
- Food: earthy. Quirk: food from the ground — honest, unadorned.
- Role: Captain. Lean: Will/Fate (her stillness steadies everyone).

### Orenmir the Grey
- Oldest of the Mithlost, grey as the name they carry. Has led before, in ages
  he won't discuss, and would rather not lead again — but will.
- Food: earthy. Quirk: plain food, taken slowly.
- Role: Captain. Lean: Will/Fate (a reluctant, weighty authority).
...
**Captains**
### Keldra
- Youngest in the company. Ambitious in a way she hasn't learned to hide. Wants
  to be the best and, on her better days, isn't far off.
- Food: spicy. Quirk: bold flavors for a bold dwarf.
- Role: Captain. Lean: Will/Fate (drive becoming leadership).

### Durgan Stoneword
- Old captain of a hold that fell; carries the loss like a stone in the chest and
  the lesson like a blade. The company quiets when he speaks.
- Food: hearty. Quirk: the same meal nightly, by ritual.
- Role: Captain. Lean: Will/Fate (grief tempered into authority).
...
## Role Coverage (permadeath insurance — TWO of every role per band)
...
## Note
Role + stat "leanings" are STARTING TENDENCIES only (progression.md: greatness is
made, not born). Any member can be grown into any role through the player's
provisioning and the deeds they survive. Leanings exist so each band has a
coherent natural starting party and built-in role insurance — never to lock
anyone into a class. Melee vs ranged is FLAVOR, but the underlying stat profile
(Might vs Agility) is mechanically meaningful.
