...
const FOOD_MODEL = (function () {
  ...
  const RECIPES = [
    ...
    { id:"bree_root_pottage",      name:"Bree Root Pottage",        cookLevel:1,  primaryStat:"vit", primaryBoost:2,  secondaryStat:null,  secondaryBoost:0 },
    { id:"pipeweed_crumble",       name:"Pipeweed Crumble",         cookLevel:4,  primaryStat:"wil", primaryBoost:4,  secondaryStat:"vit", secondaryBoost:2 },
    { id:"crabapple_blush_tart",   name:"Crabapple Blush Tart",     cookLevel:1,  primaryStat:"agi", primaryBoost:2,  secondaryStat:null,  secondaryBoost:0 },
    { id:"rendered_hearth_pie",    name:"Rendered Hearth Pie",      cookLevel:5,  primaryStat:"mig", primaryBoost:4,  secondaryStat:"vit", secondaryBoost:2 },
    { id:"lone_lands_venison",     name:"Lone-Lands Venison",       cookLevel:10, primaryStat:"mig", primaryBoost:6,  secondaryStat:"vit", secondaryBoost:3 },
    { id:"old_forest_broth",       name:"Old Forest Broth",         cookLevel:1,  primaryStat:"wil", primaryBoost:2,  secondaryStat:null,  secondaryBoost:0 },
    { id:"roadwise_berry_mix",     name:"Roadwise Berry Mix",       cookLevel:5,  primaryStat:"agi", primaryBoost:4,  secondaryStat:"vit", secondaryBoost:2 },
    { id:"marshwort_tonic",        name:"Marshwort Tonic",          cookLevel:4,  primaryStat:null,  primaryBoost:0,  secondaryStat:null,  secondaryBoost:0, hazardEffect:"hale" },
    { id:"wolf_moss_draught",      name:"Wolf-moss Draught",        cookLevel:5,  primaryStat:null,  primaryBoost:0,  secondaryStat:null,  secondaryBoost:0, hazardEffect:"alert" },
    { id:"weather_hills_grouse",   name:"Weather Hills Grouse",     cookLevel:10, primaryStat:"mig", primaryBoost:6,  secondaryStat:"vit", secondaryBoost:3 },
    { id:"crowberry_warmth_draught", name:"Crowberry Warmth Draught", cookLevel:5, primaryStat:null,  primaryBoost:0,  secondaryStat:null,  secondaryBoost:0, hazardEffect:"warmth" },
    // ── Mithlost ──────────────────────────────────────────────────────────
